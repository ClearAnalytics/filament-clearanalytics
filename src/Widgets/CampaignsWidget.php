...
class CampaignsWidget extends AnalyticsTableWidget
{
    protected function heading(): string
    {
        return (string) __('clear-analytics::clear-analytics.widgets.campaigns');
    }
    ...
    protected function columns(): array
    {
        return [
            TextColumn::make('name')
                ->label(__('clear-analytics::clear-analytics.columns.campaign'))
                ->wrap(),
    ...
    {
        return ClearAnalytics::campaigns($this->caParams() + ['limit' => 10]);
    }
}
